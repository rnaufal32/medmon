...
class MentionController extends Controller
{
    ...
    private function dataList($target, $type, $startDate, $endDate)
    {
        if ($type == 'News') {
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Client/Mention', [
            'analytic' => fn() => $this->globalChart($type, $startDate, $endDate),
            'data' => fn() => $this->dataList($targets, $type, $startDate, $endDate),
            'target' => $target,
            'platforms' => $platforms
        ]);
    }
