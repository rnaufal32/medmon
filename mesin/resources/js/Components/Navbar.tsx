    ...
    return (
        <header
            ...
            <nav className="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
                       ...
                       href="#" aria-label="Preline">
                        <svg className="w-28 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none"
                            ...
                            <path
                                ...
                                className="fill-blue-600" fill="currentColor"/>
                            <path
                ...
                <div
                    className="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
                    ...
                    <div className="hidden md:block">
                        <div className="relative">
                            ...
                            <div
                                className="absolute inset-y-0 end-0 flex items-center pointer-events-none z-20 pe-3 text-gray-400">
                                <svg className="shrink-0 size-3 text-gray-400"
                                     xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                     viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
                                     strokeLinecap="round" strokeLinejoin="round">
                                    <path
                                ...
                                <span className="mx-1">
                                      <svg className="shrink-0 size-3 text-gray-400" xmlns="http://www.w3.org/2000/svg"
                                           width="24" height="24"
                                           viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"
                                           strokeLinecap="round"
                                           strokeLinejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                                    </span>
                    ...
                    <div className="flex flex-row items-center justify-end gap-1">
                        ...
                        <div className="hs-dropdown [--placement:bottom-right] relative inline-flex">
                            <button id="hs-dropdown-account" type="button"
                                ...
                                <Icon icon={"fluent:person-circle-28-filled"} width={36} height={36}/>
                            </button>
                            ...
                            <div
                                ...
                                <div className="p-1.5 space-y-0.5">
                                    <a className="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                                       href={route('signout')}>
                                        <Icon icon="clarity:power-solid" width={24} height={24}/>
                                        Logout
                                    </a>
                                </div>
                            </div>
