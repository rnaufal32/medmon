                ...
                <div className="p-4 md:p-5">
                    <div className='h-[30vh] w-full'>
                        <Line
                            ...
                            // data={params.analytic}
                            data={{
                                ...params.analytic,
                                datasets: params.analytic.datasets.map((dataset: any, index: number) => ({
                                    ...dataset,
                                    backgroundColor: index === 0 ? 'rgba(34, 197, 94, 0.2)' :
                                        index === 1 ? 'rgba(107, 114, 128, 0.2)' :
                                            'rgba(239, 68, 68, 0.2)',
                                    borderColor: index === 0 ? 'rgba(34, 197, 94, 1)' :
                                        index === 1 ? 'rgba(107, 114, 128, 1)' :
                                            'rgba(239, 68, 68, 1)',
                                    borderWidth: 2,
                                    fill: true,
                                })),
                    ...
                    <div className="flex flex-col bg-white border shadow-sm rounded-xl p-4 md:p-5">
                        <div>
                            <label htmlFor="input-label"
                                className="block text-sm font-medium mb-2 dark:text-white">Sentiment</label>
