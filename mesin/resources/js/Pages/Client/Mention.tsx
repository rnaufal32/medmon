        ...
        <AdminLayout>
            ...
            <div className="grid grid-cols-3 gap-5">
                {params.data.data.length > 0 ? (
                    ...
                    <div className='col-span-2 grid grid-cols-1 gap-5'>
                        <div
                            className="flex flex-col items-center justify-center border shadow-sm rounded-xl p-4 md:p-5">
                            <h1>Currently, There's no data <span className="font-semibold">Mentions</span> to display
                            </h1>
                        </div>
                    </div>
                )}
